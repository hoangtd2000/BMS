...
#define get_speed_x()     __HAL_TIM_GET_AUTORELOAD(&htim8)
...
#define get_speed_y()     __HAL_TIM_GET_AUTORELOAD(&htim1)
...
#define get_speed_z()     __HAL_TIM_GET_AUTORELOAD(&htim3)
...
#define period_x  2000000U
#define period_y  2000000U
#define period_z  1000000U

#define speed_x_max (50000U)
#define speed_y_max (50000U)
#define speed_z_max (10000U)
